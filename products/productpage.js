...
async function fetchObjects() {
    ...
    try {
      ...
      products = data; // Store the fetched objects in the 'products' array
  
      // Do something with the 'products' array if needed
  
      console.log(products); // Print the array to the console
    } catch (error) {
